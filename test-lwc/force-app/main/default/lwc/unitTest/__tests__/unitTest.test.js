...
describe('c-unit-test', () => {
  ...
  it('displays unit status with updated unitNumber', () => {
    ...
    //expect(div.textContent).toBe('Unit 6 alive!'); // genera error porque no espera a que se actualice el DOM
    
    //ahora si este expect  utiliza el .not.tobe y la PROMESA para esperar que se actualice el DOM
